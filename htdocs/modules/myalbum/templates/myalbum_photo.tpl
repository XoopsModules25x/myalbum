                ...
                <table border='0' cellpadding='0' cellspacing='0' width='100%'>
                    <tr>
                        ...
                        <span style="font-weight:bold;">
                            <a href='index.php'><{$lang_album_main}></a>&nbsp;:&nbsp;<{$album_sub_title}>
                            &nbsp;<{$photo.title}>
                        </span>
                        </td>
                        <td align='right'>
                            ...
                            <strong><{$photo.title}></strong>
                                ...
                                <br>
                                    ...
                                    <img src='<{$mod_url}>/assets/images/clock.gif' width='16' height='16'
                                         alt='<{$lang_lastupdatec}>' title='<{$lang_lastupdatec}>'/>
                                    <{$photo.datetime}>
                                    ...
                                    <br>
                                        ...
                                        <{if $canratevote}>
                                            <a href='<{$mod_url}>/ratephoto.php?lid=<{$photo.lid}>'>
                                                <img src='<{$mod_url}>/assets/images/vote.gif'
                                                     alt='<{$lang_ratethisphoto}>' title='<{$lang_ratethisphoto}>'
                                                     border='0'/>
                                                <{$lang_ratethisphoto}>
                                            </a>
                                        <{/if}>
