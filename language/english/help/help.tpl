<div id="help-template" class="outer">
    <h1 class="head">Help:
        <a class="ui-corner-all tooltip" href="<{$xoops_url}>/modules/myalbum/admin/index.php"
           title="Back to the administration of MyAlbum"> MyAlbum
            <img src="<{xoAdminIcons home.png}>"
                 alt="Back to the Administration of MyAlbum">
        </a></h1>

    <h4 class="odd">DESCRIPTION</h4>

    <p class="even">This module creates a photos section where users can search/submit/rate various photos.<b> <b>
    </p>
