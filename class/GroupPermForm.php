...
class GroupPermForm extends \XoopsForm
{
            ...
            foreach ($first_child as $fcid) {
                ...
                if (!empty($this->_itemTree[$fcid]['children'])) {
                    foreach ($this->_itemTree[$fcid]['children'] as $_fcid) {
                        $childIds[] = $_fcid;
                        $this->loadAllChildItemIds($_fcid, $childIds);
                    }
                }
            }
        }
    ...
    public function render()
    {
        ...
        foreach (\array_keys($this->_itemTree) as $item_id) {
            ...
            $this->loadAllChildItemIds($item_id, $this->_itemTree[$item_id]['allchild']);
        }
        ...
        foreach (\array_keys($glist) as $i) {
            ...
            $ele      = new Myalbum\GroupFormCheckBox($glist[$i], 'perms[' . $this->_permName . ']', $i, $selected);
