    ...
    <tr>
        <td class="even" align="left">
            ...
            <div align="center">
                <{$lang_sortby}>&nbsp;&nbsp;
                <{$lang_title}> (
                <a href="viewcat.php?cid=<{$category_id}>&amp;uid=<{$uid}>&amp;orderby=titleA"><img src="assets/images/up.gif" border="0" align="middle" alt=""/></a>
                <a href="viewcat.php?cid=<{$category_id}>&amp;uid=<{$uid}>&amp;orderby=titleD"><img src="assets/images/down.gif" border="0" align="middle" alt=""/></a>)&nbsp;
                <{$lang_date}> (
                ...
                <a href="viewcat.php?cid=<{$category_id}>&amp;uid=<{$uid}>&amp;orderby=dateD">
                    <img src="assets/images/down.gif" border="0" align="middle" alt=""/></a>)&nbsp;
                <{if $canrateview }>
                <{$lang_rating}> (
                ...
                <{/if}>
                <{$lang_popularity}> (
                <a href="viewcat.php?cid=<{$category_id}>&amp;uid=<{$uid}>&amp;orderby=hitsA"><img src="assets/images/up.gif" border="0" align="middle" alt=""/> </a>
                <a href="viewcat.php?cid=<{$category_id}>&amp;uid=<{$uid}>&amp;orderby=hitsD"><img src="assets/images/down.gif" border="0" align="middle"
                                                                                                    alt=""/></a>)
                <br/>
