            ...
            <div align="center">
                ...
                <table class="outer">
                    ...
                    <tr>
                        ...
                        <td class="odd" align="left"><a href='photo.php?cid=<{$photo.cid}>&amp;lid=<{$photo.lid}>'><{$photo.title}></a></td>
                        ...
                        <{/if}>
                        <{if $xoConfig.tag}>
                        <td class='even'><{include file="db:tag_bar.html" tagbar=$photo.tagbar}></td>
                        <{/if}>
                    </tr>
