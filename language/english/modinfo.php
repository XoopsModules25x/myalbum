...
if (defined('FOR_XOOPS_LANG_CHECKER') || !defined('MYALBUM_MI_LOADED')) {
    ...
    //define("_ALBM_CFG_USEIMAGICK","Use ImageMagick for editing images");
    //define("_ALBM_CFG_DESCIMAGICK","Use ImageMagick because GD doesn't resize or rotate the main photo, and doesn't make thumbnails.<br>If you can, please use ImageMagick.");
    define('_ALBM_CFG_IMAGINGPIPE', 'Package to edit images');
    ...
    define('_ALBM_CFG_DESCFORCEGD2', 'Even if the GD is bundled with PHP, it forces GD2(truecolor) conversion.<br>Some configured PHP fails to create thumbnails in GD2<br>This configuration is significant only when using GD');
    ...
    define('_ALBM_CFG_ALLOWNOIMAGE', 'Allows a submit without images');
    ...
    define('_ALBUM_OPT_CALCWHINSIDEBOX', 'put in specified size square');
