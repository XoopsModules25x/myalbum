<table width="100%" border='0' cellspacing='5' cellpadding='0' align="center">
    <tr>
        ...
        <td valign="top" align="left" width="33%">
            ...
            <a href="<{$mod_url}>/viewcat.php?cid=<{$subcat.cid}>"><img src="<{xoModuleIcons16 topic.png}>" width="16" height="16" alt=""/><{$subcat.title}><img src='<{$mod_url}>/assets/images/subcat.gif' width='15' height='15'/></a> &nbsp;
            <{else}>
