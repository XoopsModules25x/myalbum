...
if (defined('FOR_XOOPS_LANG_CHECKER') || !defined('MYALBUM_MB_LOADED')) {
    ...
    define('_ALBM_FILEERROR', 'Error: Photos are too big or some troubles about configuration have occurred');
    ...
    define('_ALBM_ANONNOTALLOWED', 'Anonymous user is not allowed to post.');
    ...
    define('_ALBM_CIDASC', 'Category Weight (Higher to Lower)');
    define('_ALBM_CIDDESC', 'Category Weight (Lower to Higher)');
    ...
    define('_ALBM_THEREARE', 'There are <strong>%s</strong> Images in our Database.');
    ...
    define('_ALBM_NOMATCH', 'No matching photo found');
