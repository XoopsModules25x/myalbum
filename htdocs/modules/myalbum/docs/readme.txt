...
Especially, ImageManager integration is useful for almost all XOOPS users.
...
This means that you can attach any type of files (PDF, Excel, Word ... yes!) into almost all modules which have XoopsDhtmlTextarea.
