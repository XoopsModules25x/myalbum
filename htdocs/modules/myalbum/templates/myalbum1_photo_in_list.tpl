<tr>
    <{strip}>
            ...
            <div align='center'>
                <{if $photo.is_normal_image }>
                    ...
                    <a href='<{$mod_url}>/photo.php?lid=<{$photo.lid}>'><img
                                src='<{$photo.imgsrc_thumb}>' <{$photo.width_spec}> alt='<{$photo.title}>'
                                title='<{$photo.title}>'/></a>
                <{else}>

                    <{* FILES OTHER THAN IMAGES *}>
                    <a href='<{$photo.ahref_photo}>' target='_blank'><img
                                src='<{$photo.imgsrc_thumb}>' <{$photo.width_spec}> alt='<{$photo.title}>'
                                title='<{$photo.title}>'/></a>
                <{/if}>
            </div>
        ...
        <td align='left'>
            ...
            <{* VOTE BUTTON *}>
            <{if $canratevote}>
                <a href='<{$mod_url}>/ratephoto.php?lid=<{$photo.lid}>'><img src='<{$mod_url}>/assets/images/vote.gif'
