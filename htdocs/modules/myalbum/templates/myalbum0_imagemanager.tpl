...
<form action="<{$xoops_url}>/imagemanager.php" method="get">
    <table cellspacing="0" id="imagenav">
        <tr>
            ...
            <{if $can_add}>
            <td align="right"><input type="button" value="<{$lang_addimage}>" onclick='window.open("<{$mod_url}>/submit.php?cid=<{$cid}>&amp;caller=imagemanager","submitphoto","WIDTH=600,HEIGHT=540,SCROLLBARS=1,RESIZABLE=1,TOOLBAR=0,MENUBAR=0,STATUS=0,LOCATION=0,DIRECTORIES=0");'/> </td>
            <{/if}>
        </tr>
    </table>
</form>
...
<table cellspacing="0" id="imagemain">
    ...
    <tr align="center">
        ...
        <td nowrap="nowrap">
            ...
            <a href="#" onclick="appendCode('<{$photo.xcodel}>');"><img src="<{$mod_url}>/assets/images/alignleft.gif" alt="<{$lang_left}>" title="<{$lang_left}>"/></a>
            <a href="#" onclick="appendCode('<{$photo.xcodec}>');"><img src="<{$mod_url}>/assets/images/aligncenter.gif" alt="<{$lang_center}>" title="<{$lang_center}>"/></a>
            <a href="#" onclick="appendCode('<{$photo.xcoder}>');"><img src="<{$mod_url}>/assets/images/alignright.gif" alt="<{$lang_right}>" title="<{$lang_right}>"/></a>
            <br/>
            <br/>
            <{/if}>
            <{if $photo.is_normal}>
            <a href="#" onclick="appendCode('<{$photo.xcodebl}>');"><img src="<{$mod_url}>/assets/images/alignbigleft.gif" alt="<{$lang_left}>" title="<{$lang_left}>"/></a>
            <a href="#" onclick="appendCode('<{$photo.xcodebc}>');"><img src="<{$mod_url}>/assets/images/alignbigcenter.gif" alt="<{$lang_center}>" title="<{$lang_center}>"/></a>
            <a href="#" onclick="appendCode('<{$photo.xcodebr}>');"><img src="<{$mod_url}>/assets/images/alignbigright.gif" alt="<{$lang_right}>" title="<{$lang_right}>"/></a>
            <{/if}>
