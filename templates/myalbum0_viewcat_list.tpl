                ...
                <td class="even" align="left">
                    <{if $photo_small_sum > 1 }>
                        <div align="center">
                            <{$lang_sortby}>&nbsp;&nbsp;
                            <{$lang_title}> (
                            <a href="viewcat.php?cid=<{$category_id}>&amp;uid=<{$uid}>&amp;orderby=titleA"><img
                                        src="assets/images/up.gif" border="0" align="middle" alt=""></a>
                            <a href="viewcat.php?cid=<{$category_id}>&amp;uid=<{$uid}>&amp;orderby=titleD"><img
                            ...
                            <{/if}>
                            <{$lang_popularity}> (
                            <a href="viewcat.php?cid=<{$category_id}>&amp;uid=<{$uid}>&amp;orderby=hitsA"><img
                                        src="assets/images/up.gif" border="0" align="middle" alt=""> </a>
                            <a href="viewcat.php?cid=<{$category_id}>&amp;uid=<{$uid}>&amp;orderby=hitsD"><img
