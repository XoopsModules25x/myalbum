...
if (defined('FOR_XOOPS_LANG_CHECKER') || !defined('MYALBUM_MB_LOADED')) {
    ...
    // New MyAlbum 1.0.0
    define('_ALBM_PHOTOBATCHUPLOAD', 'Register photos already uploaded to the server');
    ...
    define('_ALBM_FILEERROR', 'Error: Photos are too big or there are some other configuration issues');
